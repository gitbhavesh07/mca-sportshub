...
describe("<ActionPanel AllPlayers>", () => {
  ...
  test("Available Players", async () => {
    render(
      <BrowserRouter>
        <MockedProvider mocks={mockData} addTypename={false}>
          <AllPlayers AvailablePlayer={true} />
        </MockedProvider>
      </BrowserRouter>
    );
    screen.debug(undefined, Infinity);
  ...
  test("Sold Players", async () => {
    render(
      <BrowserRouter>
        <MockedProvider mocks={mockData} addTypename={false}>
          <AllPlayers SoldPlayer={true} />
        </MockedProvider>
      </BrowserRouter>
    );
    screen.debug(undefined, Infinity);
  ...
  test("No Players", async () => {
    ...
    screen.debug(undefined, Infinity);
    await new Promise(resolve => setTimeout(resolve,2000))
    expect(screen.findByText("No Players"));
  });
});
